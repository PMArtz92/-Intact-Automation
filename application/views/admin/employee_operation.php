<div class="content">
    <div class="container_12">
        <div class="grid_12">
            <h3>Employee Add and Update Operations</h3>
            <form action="<?php echo base_url()?>index.php/home/employee_signup" style="float: right"><input type="submit" value="Add Employee" class="service-btn"></form>
        </div>

        <div class="grid_12">
            <form id="manager-form"  method="post" action="<?php echo base_url()?>index.php/home/search_employee">
            ...
            <table class='table_content'>
                ...
                <?php foreach($posts as $post ) {?>
                    <tr>
                        ...
                        <td class='grid_2' align='center'><a href="<?php echo base_url()?>index.php/home/delete_employee/<?php echo $post->User_ID ?>" class='Remove'>Remove</a>
                        </td>
                    </tr>
