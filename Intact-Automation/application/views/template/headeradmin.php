                ...
                <div class="grid_12">
                    <nav class="horizontal-nav full-width horizontalNav-notprocessed">
                        <ul class="sf-menu">
                            ...
                            <!--class="current"-->
                            <li><a href="<?php echo base_url()?>index.php/home/manager">Manager</a></li>
                            <li><a href="<?php echo base_url()?>index.php/home/employee">Employee</a></li>
                            <li><a href="<?php echo base_url()?>index.php/home/report">Report</a></li>
                            <li><a href="<?php echo base_url()?>index.php/home/booking">Bookings</a></li>
                            <li><a href="<?php echo base_url()?>index.php/home/mobile_assit">Mobile Assit</a></li>
                        </ul>
                    </nav>
                    <div class="clear"></div>
                </div>
